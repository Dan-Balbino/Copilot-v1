...
# IA para controlar Injeção eletrica,

# Avisar caso tenha velocidade alta, Analise do pneu do carro, Analise do tanque de combustivel,

# AIzaSyAdEOoQWpNNkZ1GiOA9onDQ0SkoKY6sIOY
